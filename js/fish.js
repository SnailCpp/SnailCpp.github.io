var RENDERER = {
    ...
    render : function(){
        ...
        var cssFill = getComputedStyle(document.documentElement)
            .getPropertyValue("--fish-fill-color")
            .trim();
        var fillColor = cssFill || (scheme === "dark"
        ...
        for(var j = 0, count = this.points.length; j < count; j++){
...
function initFish() {
    if (!document.getElementById("jsi-flying-fish-container")) return;
    RENDERER.init();
}
